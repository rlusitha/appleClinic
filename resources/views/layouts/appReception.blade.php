...
<head>
    ...
    <!-- Title Page-->
    <title>Apple Wound Care - @yield('title')</title>
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="{{ asset('theme/images/icon/reception/reception.png') }}" alt="Reception" />
                </a>
            </div>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="{{ asset('theme/images/icon/dinithi.jpg') }}" alt="Dinithi Perera" />
                                        </div>
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Dinithi Perera</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">Dinithi Perera</a>
                                                    </h5>
                                                    <span class="email">dinithi_88@gmail.com</span>
                                                </div>
                                            </div>
